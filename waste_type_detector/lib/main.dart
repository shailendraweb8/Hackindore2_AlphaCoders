...
class _MyAppState extends State<MyApp> {
  ...
  Future predictImagePickercam() async {
  ...
  Widget build(BuildContext context) {
    ...
    if (_model == deeplab && _recognitions != null) {
      stackChildren.add(Positioned(
        ...
        width: size.width,
        child: _image == null
            ? Padding(padding: const EdgeInsets.only(top:100.0),child: Text('No image selected.'),)
            : Container(
            decoration: BoxDecoration(
      ...
      stackChildren.add(Positioned(
        ...
        left: 0.0,
        width: size.width,
        child: _image == null ? Padding(padding: const EdgeInsets.only(top: 100),child: Center(child: Text('No image selected.',style: TextStyle(fontSize: 25.0),),),) : Image.file(_image),
      ));
    }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Waste Type Detector'),
        actions: <Widget>[
      ...
      bottomSheet: Row(
        children: <Widget>[
          value1!=null?Padding(
            ...
            child: Container(
              child: finl==1?Image.asset("assets/dry.png",height: 200,width:110):Image.asset("assets/liquid.png",height: 200,),
            ),
          ):Text(""),
